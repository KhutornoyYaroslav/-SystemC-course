...
int sc_main(int argc, char* argv[]) 
{
    ...
    // Connect the DUT
	fifoparaminherit<int> test_fifo("test_fifo", 5);	
	...
	{	
		...
		cout << "@" << sc_time_stamp() << " Only Push - " << data_in << "; full = " << 
			full.read() << "; empty = " << empty.read() << "; almost_full = " << almost_full << "; almost_empty = " << almost_empty << ";" << endl;
		assert( !full && !empty);
